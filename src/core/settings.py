...
config = dict(
    ...
    custom_domain=os.getenv("MINIO_CUSTOM_DOMAIN", f"localhost:9005/cctv"),
)
STORAGES = {
    "default": {
...
UNFOLD = {
    ...
    "DASHBOARD_CALLBACK": "cctv.views.dashboard_callback",
    # "THEME": "dark",  # Force theme: "dark" or "light". Will disable theme switcher
    # "LOGIN": {
    #     "image": lambda request: static("sample/login-bg.jpg"),
    #     "redirect_after": lambda request: reverse_lazy("admin:cctv_changelist"),
    # },
    # "STYLES": [
                ...
                "items": [
                    {
                        ...
                        # "badge": "cctv.badge_callback",
                        # "permission": lambda request: request.user.is_superuser,
                    },
                    {
                        "title": "Cameras",
                        "icon": "videocam",  # Supported icon set: https://fonts.google.com/icons
                        "link": reverse_lazy("admin:cctv_camera_changelist"),
                        # "badge": "cctv.badge_callback",
                        # "permission": lambda request: request.user.is_superuser,
                    },
                    {
            ...
            "items": [
                {
                    "title": "Cameras",
                    "link": reverse_lazy("admin:cctv_camera_changelist"),
                    # "permission": "cctv.permission_callback",
                },
                {
                    "title": "Tags",
                    "link": reverse_lazy("admin:cctv_tag_changelist"),
                    # "permission": lambda request: request.user.is_superuser,
                },
            ],
        },
